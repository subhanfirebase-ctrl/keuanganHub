...
# Tampilan halaman chat dengan Logo Spesifik milikmu & Ikon Pesawat SVG
HTML_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        /* Header yang disesuaikan untuk Logomu */
        .header { background: linear-gradient(135deg, #1e3c72, #2a5298); color: white; padding: 12px 18px; display: flex; align-items: center; justify-content: center; gap: 12px; }
        .header img { height: 38px; width: 38px; border-radius: 50%; object-fit: cover; background: #fff; padding: 2px; }
        .header-title { font-weight: bold; font-size: 1.2em; letter-spacing: 0.5px; }
        ...
        input[type="text"] { flex: 1; padding: 14px 20px; border: 1px solid #ccc; border-radius: 24px; font-size: 16px; outline: none; transition: 0.2s; }
        input[type="text"]:focus { border-color: #2a5298; box-shadow: 0 0 0 3px rgba(42,82,152,0.1); }
        
        /* Tombol Kirim Bundar dengan SVG Pesawat */
